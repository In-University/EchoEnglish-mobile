...
//
//        llSkillContainer = view.findViewById(R.id.llSkillContainer);
//        this.container = view.findViewById(R.id.myAnswerContainer);
//
//        List<SkillData> skillDataList = new ArrayList<>();
//        skillDataList.add(new SkillData("Duration", String.format(Locale.US, "%.1f s", totalDuration)));
//        skillDataList.add(new SkillData("Words", String.format(Locale.US, "%d", wordCount)));
//        skillDataList.add(new SkillData("Speed", String.format(Locale.US, "%.2f WPM", speakingRate)));
//        skillDataList.add(new SkillData("Filtered", String.format(Locale.US, "%d", filterWordCount)));
//
//        for (SkillData skill : skillDataList) {
//            View skillView = inflater.inflate(R.layout.skill_item, llSkillContainer, false);
//
//            TextView tvSkillTitle = skillView.findViewById(R.id.tvSkillTitle);
//            TextView tvSkillLevel = skillView.findViewById(R.id.tvSkillLevel);
//            TextView tvSkillProgress = skillView.findViewById(R.id.tvSkillProgress);
//
//            tvSkillTitle.setText(skill.label);
//            tvSkillLevel.setText("This is feedback about your speech. You can This is " +
//                    "feedback about your speech. You can This is feedback about your speech. " +
//                    "You can This is feedback about your speech. You can ");
//            tvSkillProgress.setText(skill.value);
//
//            llSkillContainer.addView(skillView);
//        }
//
//        // Thêm PhonemeTextView vào container
//        addPhonemeTextView();
//
//        // Thiết lập PieChart
//        PieChart pieChart = view.findViewById(R.id.pieChart);
