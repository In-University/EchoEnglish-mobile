...
//        setTitle(getFolderNameFromSharedPreferences());
    ...
    private void loadAnimations() {
        mSetRightOut = (AnimatorSet) AnimatorInflater.loadAnimator(this, R.animator.animation_card_out);
        mSetLeftIn = (AnimatorSet) AnimatorInflater.loadAnimator(this, R.animator.animation_card_in);
    }
